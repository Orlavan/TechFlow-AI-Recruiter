...
Handles interview scheduling with Function Calling to interact with MongoDB database.
...
# Import database tools from the schedule module
from app.modules.schedule.db_manager import MongoDBManager as DatabaseManager, SCHEDULING_TOOLS, execute_function_call
